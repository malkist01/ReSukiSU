...
static apk_sign_key_t apk_sign_keys[] = {
    ...
    { EXPECTED_SIZE_WILD, EXPECTED_HASH_WILD }, // Wild/WildKSU
    { EXPECTED_SIZE_MAMBO, EXPECTED_HASH_MAMBO }, // RapliX/MamboSU
    { EXPECTED_SIZE_NEXT, EXPECTED_HASH_NEXT }, // KernelSU-Next/KernelSU-Next
    { EXPECTED_SIZE_ENJOY, EXPECTED_HASH_ENJOY }, // Three/Enjoy
